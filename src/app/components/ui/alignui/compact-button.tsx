// AlignUI CompactButton v0.0.0 — vendored from https://alignui.com/docs/v1.2/ui/compact-button
// Only change vs. upstream: `@/utils/*` imports rewritten to local relative paths.
