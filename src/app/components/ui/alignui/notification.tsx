// AlignUI Notification v0.0.0 — vendored from https://alignui.com/docs/v1.2/ui/notification
// Changes vs. upstream: `@/utils/*` and `@/components/ui/*` imports rewritten to
// local relative paths; the five remixicon status icons swapped for lucide-react
// equivalents (this project uses lucide throughout).
