// AlignUI Modal v0.0.0 — vendored from https://alignui.com/docs/v1.2/ui/modal
// Changes vs. upstream:
//   • `@/utils/*` and `@/components/ui/*` imports rewritten to local relative paths;
//   • `@remixicon/react` (RiCloseLine / RemixiconComponentType) swapped for
//     lucide-react's `X` + a local icon-component type, so we don't add a second
//     icon library — this project already uses lucide everywhere.
...
// Minimal stand-in for RemixiconComponentType — matches lucide icon components.
