// AlignUI notification store — vendored from https://alignui.com/docs/v1.2/ui/notification
// Changes vs. upstream: dropped the Next-only `'use client'` directive and rewrote
// the `@/components/ui/notification` type import to a local relative path.
